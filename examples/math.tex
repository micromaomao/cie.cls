...
\begin{document}
  ...
  \begin{question}%
    ...
    \subquestion Show that John has 2 apples left. \point{1}
    \writinglinesfor{2cm}
    \markschemecontent{
    ...
    \markschemecontent{
      ...
      To convert instagrams back into grams you use instagration. See \url{https://www.reddit.com/r/shittyaskscience/comments/1dicsm}
    }
